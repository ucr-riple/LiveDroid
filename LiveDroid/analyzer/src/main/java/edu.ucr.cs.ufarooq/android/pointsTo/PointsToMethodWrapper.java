...
public class PointsToMethodWrapper {
    private SootMethod method;
    private Unit callSite;
    private SootMethod caller;


    public PointsToMethodWrapper(SootMethod method, Unit callSite, SootMethod caller) {
        this.method = method;
    ...
    public boolean equals(Object o) {
        ...
        PointsToMethodWrapper wrapper = (PointsToMethodWrapper) o;
